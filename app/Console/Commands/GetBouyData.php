...
class GetBouyData extends Command
{
    ...
    {
        $limit = 100;
        $response = Http::timeout(1800)->get('http://export.blueoceangear.com:4321/api/v1/export_data/?user_id=111&user_mobile=%2B14158478829&skip=0&limit=' . $limit);
        ...
        for ($i=1; $i <= $total_page; $i++) {
            $datas = Http::timeout(1800)->get('http://export.blueoceangear.com:4321/api/v1/export_data/?user_id=111&user_mobile=%2B14158478829&skip=' . $skip . '&limit=' . $limit);
